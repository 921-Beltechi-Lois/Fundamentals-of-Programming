...
class Activity_Repo:
    ...
    def generate_activities(self):
        ...
        self.__activity_list = [
            Activity(500, [100, 123, 124], datetime.datetime(2020, 5, 17, 20), datetime.datetime(2020, 5, 17, 21),
                     "Swimming"),
            Activity(199, [122, 555, 600, 900], datetime.datetime(2021, 5, 17, 10), datetime.datetime(2021, 5, 17, 11),
                     "General gardening"),
            Activity(600, [124, 800], datetime.datetime(2020, 6, 17, 19), datetime.datetime(2020, 6, 17, 20),
                     "Cycling"),
            ...
            Activity(333, [55, 87, 12], datetime.datetime(2021, 2, 18, 13), datetime.datetime(2021, 2, 18, 14),
                     "Vacuuming"),
            Activity(609, [40, 95], datetime.datetime(2021, 9, 18, 11), datetime.datetime(2021, 9, 18, 12), "Football"),
            Activity(697, [10, 20, 145, 367, 987], datetime.datetime(2021, 7, 20, 22),
                     datetime.datetime(2021, 7, 20, 23), "Basketball"),
            ...
            Activity(66, [367, 555, 987], datetime.datetime(2021, 2, 16, 10), datetime.datetime(2021, 2, 16, 11),
                     "Sweeping"),
            Activity(88, [95], datetime.datetime(2021, 11, 9, 7), datetime.datetime(2021, 11, 9, 8), "Mopping"),
            Activity(921, [12, 87, ], datetime.datetime(2021, 11, 20, 10), datetime.datetime(2021, 11, 20, 11),
                     "Running"),
            ...
            Activity(78, [100, 124, 987], datetime.datetime(2021, 12, 25, 13), datetime.datetime(2021, 12, 25, 14),
                     "Dancing"),
            Activity(606, [55, 122, 87, 367, 145], datetime.datetime(2021, 12, 25, 15),
                     datetime.datetime(2021, 12, 25, 16), "Jogging"),
            Activity(505, [122, 145], datetime.datetime(2022, 1, 1, 00), datetime.datetime(2022, 1, 1, 1),
                     "Bike Riding")
        ]

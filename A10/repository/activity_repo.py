...
class Activity_Repo:
    def __init__(self):
        self.__activity_list = MyDataStructure()
    ...
    def remove(self, given_activity_id):
        ...
        for activity in self.__activity_list:
            if given_activity_id == activity.activity_id:
                del self.__activity_list[activity.activity_id]
    ...
    def add(self, given_activity):
        ...
        self.__activity_list[given_activity.activity_id] = given_activity
    ...
    def generate_activities(self):
        self.add(Activity(500, [100, 123, 124], datetime.datetime(2020, 5, 17, 20), datetime.datetime(2020, 5, 17, 21),
                          "Swimming"))
        self.add(
            Activity(199, [122, 555, 600, 900], datetime.datetime(2021, 5, 17, 10), datetime.datetime(2021, 5, 17, 11),
                     "General gardening"))
        self.add(Activity(600, [124, 800], datetime.datetime(2020, 6, 17, 19), datetime.datetime(2020, 6, 17, 20),
                          "Cycling"))
        self.add(
        ...
        self.add(Activity(333, [55, 87, 12], datetime.datetime(2021, 2, 18, 13), datetime.datetime(2021, 2, 18, 14),
                          "Vacuuming"))
        self.add(
            Activity(569, [40, 95], datetime.datetime(2021, 9, 18, 11), datetime.datetime(2021, 9, 18, 12), "Football"))
        self.add(Activity(697, [10, 20, 145, 367, 987], datetime.datetime(2021, 7, 20, 22),
                          datetime.datetime(2021, 7, 20, 23),
                          "Basketball"))
        self.add(
        ...
        self.add(Activity(43, [800], datetime.datetime(2021, 3, 23, 14), datetime.datetime(2021, 3, 23, 15), "Tennis"))
        self.add(Activity(66, [367, 555, 987], datetime.datetime(2021, 2, 16, 10), datetime.datetime(2021, 2, 16, 11),
                          "Sweeping"))
        self.add(Activity(88, [95], datetime.datetime(2021, 11, 9, 7), datetime.datetime(2021, 11, 9, 8), "Mopping"))
        self.add(Activity(921, [12, 87], datetime.datetime(2021, 11, 20, 10), datetime.datetime(2021, 11, 20, 11),
                          "Running"))
        self.add(
        ...
        self.add(Activity(78, [100, 124, 987], datetime.datetime(2021, 12, 25, 13), datetime.datetime(2021, 12, 25, 14),
                          "Dancing"))
        self.add(Activity(606, [55, 122, 87, 367, 145], datetime.datetime(2021, 12, 25, 15),
                          datetime.datetime(2021, 12, 25, 16),
                          "Jogging"))
        self.add(Activity(505, [122, 145], datetime.datetime(2022, 1, 1, 00), datetime.datetime(2022, 1, 1, 1),
                          "Bike Riding"))

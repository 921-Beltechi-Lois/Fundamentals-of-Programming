...
class Person_Repo:
    ...
    def add(self, newPerson):
        ...
        self.__people[newPerson.person_id] = newPerson
        return newPerson
    ...
    def generate_people(self):
        self.add(Person(123, 'Popescu Adrian', '0743594501'))
        self.add(Person(124, 'Barna Doina', '0743594402'))
        self.add(Person(100, 'Bercovic Dan', '0743594511'))
        self.add(Person(122, 'Popescu Mircea', '0741354501'))
        self.add(Person(98, 'Ciorna Ioan', '0743591501'))
        self.add(Person(55, 'Antonescu Ioan', '0743599501'))
        self.add(Person(40, 'Ardelean Ioana', '0743594526'))
        self.add(Person(10, 'Burcea Gheorghe', '0731594501'))
        self.add(Person(600, 'Fagu Abel', '0723594501'))
        self.add(Person(900, 'Horalipa Rebeca', '0783594501'))
        self.add(Person(800, 'Ciuciu Felix', '0754594501'))
        self.add(Person(555, 'Deac Mirel', '0749024501'))
        self.add(Person(95, 'Radoi David', '0743567801'))
        self.add(Person(87, 'Vancea Alexandru', '0754370849'))
        self.add(Person(12, 'Garcia Eric', '0798794501'))
        self.add(Person(20, 'Ferrari Alberto', '0743186501'))
        self.add(Person(345, 'Dinu Rares', '0743851301'))
        self.add(Person(987, 'Hassan Victor', '0743569401'))
        self.add(Person(367, ' Bogosel Florina', '0743537801'))
        self.add(Person(145, 'Spiridon Cosmin', '0743107501'))
        # self.__people = [
